insert into awacs_user(id, user_name, email, password, account_expired, account_locked, credentials_expired, enabled)
  VALUES (1, 'admin', "girish.mahajan@aiocdawacs.com", /*admin1234*/'$2a$08$qvrzQZ7jJ7oy2p/msL4M0.l83Cd0jNsX6AJUitbgRXGzge4j035ha', false, false, false, true);

insert into awacs_user(id, user_name, email, password, account_expired, account_locked, credentials_expired, enabled)
  VALUES (2, 'reader', "balkrishna@aiocdawacs.com",/*reader1234*/'$2a$08$dwYz8O.qtUXboGosJFsS4u19LHKW7aCQ0LXXuNlRfjjGKwj5NfKSe', false, false, false, true);
